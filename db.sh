...
echo -e "$RED Importing YiiMP Default database values...$COL_RESET"
...
echo -e "$GREEN Sussessfully Database import SQL DUMP $COL_RESET" "$RED 2020-11-10-yaamp.sql.gz...$COL_RESET"
