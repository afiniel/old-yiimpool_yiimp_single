...
if [[ ("$UsingDomain" == "yes") ]]; then
  echo -e "$YELLOW Installation of your YiiMP single Pool is now completed.$COL_RESET"
...
echo "----------------------------------------------------------------------------"
echo
echo -e "$GREEN Thank you for using Afiniel Pool Installer!$COL_RESET"
echo
echo -e "To run this installer anytime simply type, $RED yiimpool$GREEN!"
echo -e "Donations for continued support of this script are welcomed at:"
echo
